...
<div class="login-box">
  <div class="login-logo">
    <a  href="index.html"><img src="<?php echo base_url();?>assets/theme/assets/img/panellogo.png" width="300px" heigh="300px"></a>
  </div>
  ...
  <div class="login-box-body">
   ...
   <?=form_open('C_Login/login',array('class'=>'form-signin','name'=>'Login_Form'));?>
      ...
      <div class="row">
        ...
        <div class="col-xs-12">
         <div style="color:grey; " > <?=validation_errors('');?><?=$this->session->flashdata('notif');?></div>

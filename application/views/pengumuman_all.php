	 ...
	 <div class="container mtb">
        ...
        ?>
	 		...
	 		<div class="col-lg-3">
	 			<! -- Blog Post 1 -->
	 			<div >
		 		<img  class="image-pengumuman" src="<?php echo base_url();?>file/artikel/<?=$g->img_header ?>" height="30%">
		 		</div>
		 		<h3 class="ctitle"><a title="<?=$g->title?>" href="<?=base_url(); ?>content/<?=$g->category ?>/<?=$g->slug ?>"><?=character_limiter($g->title,25) ?></a></h3>
